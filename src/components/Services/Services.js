    ...
    <div className='container'>
      ...
      <div className='my-skills'>
        <div className='skill' data-aos='fade-in' data-aos-delay={100}>
          ...
          <h1>Front-End</h1>
          <p>
            I have designed and built front-end projects with HTML,CSS Vanilla
            Javascript, in React.js and with the express handlebars framework.
          </p>
        </div>
        <br />
        ...
        <div className='skill' data-aos='fade-in' data-aos-delay={300}>
          ...
          <h1>DevOps </h1>
          <p>
            I have familiarity working with the various tools and technologies
            that are used in the devops lifecycle. I have used Git for
            Continuous Development, Jenkins and Travis CI for Continuous
            Integration. Docker and Puppet for continous Deployment, Selenium
            for Automation testing, and Nagios for Continous Monitoring
          </p>
        </div>
      </div>
    </div>
